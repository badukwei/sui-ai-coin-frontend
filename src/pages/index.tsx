...
export default function Home() {
  ...
  // ref
  const createCoinFormRef = useRef<{ focusTextarea: () => void } | null>(null);
        ...
        <section className="relative flex flex-col items-center justify-center text-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg lg:text-xl mt-4">
              Simply enter your text, and our AI will help you create a unique
              memecoin on the Sui blockchain.
            </p>

            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8">
              <button
                onClick={() => createCoinFormRef.current?.focusTextarea()}
